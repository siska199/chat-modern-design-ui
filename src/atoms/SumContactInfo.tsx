...
const SumContactInfo : React.FC<TSumContactInfoProps> = (props) => {
  const {image, username, info, type,handleOnClickImage} = props
  return (
    <div className="flex items-center gap-3">
      <Avatar  handleOnClickImage={handleOnClickImage&&handleOnClickImage} online={type==="contact"?true:false} url={image} sizeType="medium"/>
      <div>
